...
public class SmsDAO {
	...
	public int sns(SmsVO svo) {
		...
		String api_key = "발급받은 api_key"; // 발급받은 api_key
		
		String api_secret = "발급받은 api_secret"; // 발급받은 api_secret
		...
		params.put("from","발신번호(문자를 보낼 사람)"); // 발신번호(문자를 보낼 사람)-해당 api_key 소유자의 전화번호
